  ...
  return (
    <aside className="w-24 bg-[#1E3A6E] flex flex-col justify-between shrink-0 border-r border-slate-200/10 z-20 sticky top-0 h-screen">
      ...
      <div className="pb-3 border-t border-white/10 space-y-1">
        ...
        {/* User Card Box (Dr. Tung Nguyen - INSTRUCTOR) */}
        <div className="mx-2 my-2 p-2 bg-[#14274E]/80 border border-white/10 rounded-xl flex flex-col items-center justify-center text-center">
          <img
            ...
            className="w-9 h-9 rounded-full border border-amber-300/40 object-cover mb-1 shadow-xs"
          />
          <span className="font-bold text-[11px] text-white leading-tight line-clamp-1">Dr. Tung Nguyen</span>
          <span className="text-[8.5px] font-bold tracking-wider text-amber-400 uppercase mt-0.5">
            INSTRUCTOR
          </span>
        </div>
